...
## *Dataset Information*
The dataset used in this project is the **Titanic dataset**, which contains information about passengers aboard the *RMS Titanic*.
...
### **Frequency Analysis**
Studied the occurrence of different categories and values in the dataset.

### **Cumulative Frequency**
Calculated cumulative frequencies to understand data distribution and trends.
...
### **Data Visualisation**
Created simple charts and graphs to visually represent important insights from the dataset.
...
- Practical implementation of Python libraries in analytics
